...
export default function Footer() {
  return (
    <footer id="about" className="bg-dark-900 border-t border-dark-800 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#upload" className="text-gray-400 hover:text-primary-400 transition-colors duration-200">
                  Upload Resume
                </a>
              </li>
              <li>
